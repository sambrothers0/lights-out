    ...
    <>
      <main className="relative min-h-screen overflow-hidden px-6 py-12 text-stone-900 sm:px-10">
        ...
        <p className="mx-auto max-w-2xl text-center text-base text-stone-700 sm:text-lg">
          A simple implementation of the classic "Lights Out" puzzle game, built
          with ReactTS and Tailwind CSS.
        </p>
      </main>
      <dialog
        ref={dialogRef}
        className="m-auto w-full max-w-4xl rounded-[2rem] border border-white/40 bg-stone-950/80 px-6 py-10 text-center text-white shadow-[0_30px_80px_rgba(15,23,42,0.35)]  sm:px-10 sm:py-14 backdrop-blur-2xl"
      >
